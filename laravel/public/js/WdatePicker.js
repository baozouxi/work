...
(function() {
    ...
    A = $.$dpPath || J();
    if ($.$wdate) K("/css/WdatePicker.css");
    V = Y;
    if ($.$crossFrame) {
        try {
    ...
    function I(G, _) {
        ...
        function E(I, H) {
            ...
            var _ = $.$langList,
                C = $.$skinList,
                F;
            try { F = I.lastChild.contentWindow[N] } catch (D) { E = true;
            ...
            for (var L = 0; L < C.length; L++)
                if (C[L].name == H.skin) J.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"/css/datepicker.css\" charset=\"" + C[L].charset + "\"/>");
