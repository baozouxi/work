...
<div id="wrap" class="wrap">
    ...
    <div id="container" class="container">
        ...
        <div id="box" class="box">
            ...
            <div id="tablist">
                <form id="form_sub" name="form_sub" method="post" action="javascript:fastP('{{ route('book.store') }}');">
                    <div id="list_0" class="list block">
                        ...
                        <input name="name" id="name" class="input" value="" style="width:95px;" autocomplete="off" disableautocomplete="" onblur="this.style.backgroundColor='#fff';" onfocus="this.style.backgroundColor='#FFFEF1';this.style.backgroundImage='none';" type="text">
                        <input name="age" id="age" class="input" value="" style="width:35px;" autocomplete="off" disableautocomplete="" onblur="this.style.backgroundColor='#fff';" onfocus="this.style.backgroundColor='#FFFEF1';" type="text">
                        ...
                        <input name="phone" id="phone" class="input" value="" style="width:195px;" autocomplete="off" disableautocomplete="" onblur="this.style.backgroundColor='#fff';" onfocus="this.style.backgroundColor='#FFFEF1';this.style.backgroundImage='none';" type="text">
                        ...
                        <input name="undate" id="undate" class="checkbox" type="checkbox" value="1">
                    ...
                    <div id="list_1" class="list" style="display: none;">
                        <textarea name="chatlog" id="chatlog" value="sadasd" style="width: 100%; display: none;"></textarea>
                    </div>
