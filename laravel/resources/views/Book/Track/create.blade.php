    ...
    <div class="guide">
        <ul class="left">
            ...
            <li><a href="javascript:void(0);" onclick="fastH(this,'main')" url="track.asp?s=1&amp;m=res&amp;aid=5">回访记录</a> &gt; 新增回访</li>
        </ul>
    </div>
    <div id="wrap" class="wrap">
        ...
        <div id="container" class="container">
            ...
            @if($AppData->untrack == 1)
                <div id="box" class="box">
                    抱歉，该患者已经取消跟踪，如需增加记录，请先恢复跟踪！
                </div>
                {{ exit() }}
            @endif
            ...
            <div id="box" class="box">
                ...
                <form id="form_sub" name="form_sub" method="post" action="javascript:fastP('{{ route('booktrack.store') }}');">
