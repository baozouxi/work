                ...
                <table cellspacing="1" cellpadding="0">
                    ...
                    @else
                        @foreach($TrackData as $key => $trackItem)
                            ...
                            @endif
                                <td>
                                    <center><a href="javascript:void(0);" onclick="fastH(this,'main')" url="{{ route('patienttrack.show', ['id'=>$trackItem->id]) }}" title="记录编辑">{{ date('Y-m-d H:i', strtotime($trackItem->add_time))  }}</a></center>
                                </td>
