    ...
    <script type="text/javascript">
        ...
        <p class="nlink right"><a href="javascript:void(0);" onclick="fastH(this);set_title('需要跟踪');" url="turn.asp?n=2&amp;m=turn" class="call"><span class="icon">Ę</span>需要跟踪</a><a href="javascript:void(0);" onclick="fastH(this);set_title('到期回访');" url="turn.asp?n=1&amp;m=turn" class="sms"><span class="icon">ĝ</span>到期回访</a><a href="javascript:void(0);" onclick="fastH(this);set_title('今日到诊');" url="turn.asp?n=3&amp;m=res" class="sms"><span class="icon">Ğ</span>今日到诊</a></p>
    </div>
