...
<div id="wrap" class="wrap">
    ...
    <div id="container" class="container">
        ...
        <div id="box" class="box">
            <div id="tab">
                <ul>
                    <li onclick="fastT(0,7,0,'{{ $current_month }}',0,0,0)" class="now">按录入</li>
                    <li onclick="fastT(1,7,2,'{{ $current_month }}',0,0,0)">按日期</li>
                    <li onclick="fastT(2,7,3,'{{ $current_month }}',0,0,0)">按星期</li>
                    <li onclick="fastT(3,7,4,'{{ $current_month }}',0,0,0)">按月份</li>
                    <li onclick="fastT(4,7,12,'{{ $current_month }}',0,0,0)">按分类</li>
                </ul>
            </div>
            <div id="tablist">
