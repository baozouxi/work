...
<div id="wrap" class="wrap">
    ...
    <div id="container" class="container">
        ...
        <div id="box" class="box">
            <div id="tab">
                <ul>
                    <li onclick="fastT(0,6,0,'{{ $current_month }}',0,0,0)" class="now">按录入</li>
                    <li onclick="fastT(1,6,2,'{{ $current_month }}',0,0,0)">按日期</li>
                    <li onclick="fastT(2,6,3,'{{ $current_month }}',0,0,0)">按星期</li>
                    <li onclick="fastT(3,6,4,'{{ $current_month }}',0,0,0)">按月份</li>
                    <li onclick="fastT(4,6,5,'{{ $current_month }}',0,0,0)">按科室</li>
                </ul>
            </div>
            <div id="tablist">
